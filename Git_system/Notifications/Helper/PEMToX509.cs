...
namespace Git_system.Notifications.Helper
{
    internal static class PEMToX509
    {
        private const string KEY_HEADER = "-----BEGIN RSA PRIVATE KEY-----";
        private const string KEY_FOOTER = "-----END RSA PRIVATE KEY-----";

        internal static X509Certificate2 Convert(string pem, X509Certificate2 cert)
        {
            try
            {
